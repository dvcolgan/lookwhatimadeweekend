...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        # User chose to not deal with backwards NULL issues for 'Rating.custom_rater'
        raise RuntimeError("Cannot reverse this migration. 'Rating.custom_rater' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration        # Adding field 'Rating.custom_rater'
        db.add_column(u'lwimw_rating', 'custom_rater',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['lwimw.User']),
                      keep_default=False)


        # User chose to not deal with backwards NULL issues for 'Post.custom_author'
        raise RuntimeError("Cannot reverse this migration. 'Post.custom_author' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration        # Adding field 'Post.custom_author'
        db.add_column(u'lwimw_post', 'custom_author',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['lwimw.User']),
                      keep_default=False)


        # User chose to not deal with backwards NULL issues for 'Submission.custom_user'
        raise RuntimeError("Cannot reverse this migration. 'Submission.custom_user' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration        # Adding field 'Submission.custom_user'
