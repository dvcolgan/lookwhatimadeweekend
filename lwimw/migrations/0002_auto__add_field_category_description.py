...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'lwimw_category', 'description',
                      self.gf('django.db.models.fields.CharField')(default='description', max_length=255),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Category.description'
        db.delete_column(u'lwimw_category', 'description')
