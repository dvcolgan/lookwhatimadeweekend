...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        # User chose to not deal with backwards NULL issues for 'Contest.month'
        raise RuntimeError("Cannot reverse this migration. 'Contest.month' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration        # Adding field 'Contest.month'
        db.add_column(u'lwimw_contest', 'month',
                      self.gf('django.db.models.fields.PositiveIntegerField')(),
                      keep_default=False)


        # User chose to not deal with backwards NULL issues for 'Contest.year'
        raise RuntimeError("Cannot reverse this migration. 'Contest.year' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration        # Adding field 'Contest.year'
