...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Submission.contest'
        db.add_column(u'lwimw_submission', 'contest',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, related_name='submissions', to=orm['lwimw.Contest']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Submission.contest'
        db.delete_column(u'lwimw_submission', 'contest_id')
